...
import com.mycompany.auth.AuthenticationProvider;
import com.mycompany.auth.NoRedirectStrategy;
import com.mycompany.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .addFilterBefore(restAuthenticationFileter(), AnonymousAuthenticationFilter.class)
                .authorizeRequests()
    ...
    @Bean
    public TokenAuthenticationFilter restAuthenticationFileter() throws Exception {
